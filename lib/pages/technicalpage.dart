        ...
        child: Flexible(
          child: Column(
            ...
            children: <Widget>[
              ...
              Row(mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  ...
                  ShaderMask(
                    ...
                    child: Text('TECHNICAL CLUBS',style: TextStyle(
              ...
              StreamBuilder(
                stream: _firestore.collection('events').where('type',isEqualTo: 'technical').snapshots(),       //stream: _firestore.collection('events').limit(1).snapshots(),
