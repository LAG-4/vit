...
class CodingEvent extends StatefulWidget {
  @override
  _CodingEventState createState() => _CodingEventState();
}

class _CodingEventState extends State<CodingEvent> {
        ...
        child: Padding(
          ...
          child: ListView(
            children: <Widget>[
              Row(
                ...
                children: [
                  ...
                  ShaderMask(
                    ...
                    child: Text('CODING & TECHNICAL EVENTS',style: TextStyle(
              ...
              StreamBuilder(
                stream: _firestore.collection('clubs').where('type',isEqualTo: 'coding').snapshots(),
