...
import 'package:google_sheet_db/pages/approve_event.dart';
import 'package:google_sheet_db/pages/event_data.dart';
import 'package:gradient_borders/box_borders/gradient_box_border.dart';

import 'account.dart';
import 'event_approval.dart';
import 'event_report.dart';
class StudentWelfare extends StatefulWidget {

  @override
  State<StudentWelfare> createState() => _StudentWelfareState();
}

class _StudentWelfareState extends State<StudentWelfare> {
  @override
                      ...
                      children: [
                        TextButton(onPressed: (){
                          Navigator.push(context,
                            MaterialPageRoute(builder: (context)=>ApproveEvent()),
                          );
                        },
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        TextButton(onPressed: (){
                          Navigator.push(context,
                            MaterialPageRoute(builder: (context)=>EventSummary()),
                          );
                        },
                          child: Text('EVENT DATA',style: TextStyle(color: Colors.white,fontSize: 20.0,fontWeight: FontWeight.bold,fontFamily: 'Phudu'),),),
