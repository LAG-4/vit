...
class CleaningEvent extends StatefulWidget {
  @override
  _CleaningEventState createState() => _CleaningEventState();
}

class _CleaningEventState extends State<CleaningEvent> {
        ...
        child: Padding(
          ...
          child: ListView(
            children: <Widget>[
              Row(
                ...
                children: [
                  ...
                  ShaderMask(
                    ...
                    child: Text('CLEANING & SERVICE EVENTS',style: TextStyle(
              ...
              StreamBuilder(
                stream: _firestore.collection('clubs').where('type',isEqualTo: 'cleaning').snapshots(),
