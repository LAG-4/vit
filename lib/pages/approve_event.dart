          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                //     children: [
                //       DropdownButton(items: items.map(buildMenuItem).toList(),
...
class MessageBubble extends StatelessWidget {
  MessageBubble({this.img , this.desc,this.name,this.venue,this.participants,this.time,this.logo,this.cname,this.date});
  final String img;
  final String desc;
  final String name;
                ...
                children: [
                  ...
                  child: TextButton(onPressed: ()async{
                    final documentReference = FirebaseFirestore.instance
                        .collection('clubs')
                        .doc('fzHRgWZCRi1K7zcBvqjU');

                    await documentReference.update({'status': 'true'});
                  ...
                  child: TextButton(onPressed: ()async{
                    ...
                    await documentReference.update({'status': 'false'});
